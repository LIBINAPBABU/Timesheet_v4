...
def handle_send_rejection_email(employee_id,present_week_start_date,timesheetId,reason):
  # Fetch user details
    ...
    # reporting_managers_email = Submission.objects.filter(
    #     date__range=(present_week_start_date, present_week_start_date + timedelta(days=6)),
    #     assignId__assignTo=employee_id
    # ).values_list('assignId__assignBy__email', flat=True).distinct()
