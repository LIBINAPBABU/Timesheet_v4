    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', max_length=500)),
                ('pageURL', models.CharField(default='', max_length=500)),
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modules', to='Employee.modules')),
            ],
        ),
        migrations.CreateModel(
            name='PageGroup',
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Employee.page')),
            ],
        ),
        migrations.CreateModel(
            name='GroupsRole',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resigned_date', models.DateTimeField(blank=True, default=None, null=True)),
