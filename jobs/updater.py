    ...
    try:
        if scheduler is None:
            ...
            if job is None:
                ...
                scheduler.add_job(
                    schedule_api,
                    trigger=CronTrigger(day_of_week="fri,sat", hour="10,12", minute="30", second="00", timezone=utc),
                    id='testScheduler',
                    max_instances=1,
            ...
            scheduler.add_job(
                dailymail,
                trigger=CronTrigger(day_of_week="tue,wed,thu",hour="05", minute="30", second="00", timezone=utc),  # 10 AM every day
                id='dailyEmailJob',
                max_instances=1,
                replace_existing=True,
            )
